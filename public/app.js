        ...
        this.openModal(`
            <div class="page-wrapper">
                ...
                <aside class="left-panel" style="width: 38%; min-width: 420px; height: 100vh; position: relative; overflow: hidden; background: #061F17; border-bottom-right-radius: 80px; box-shadow: 12px 0 35px rgba(0, 0, 0, 0.25);">
                  ...
                  <!-- 1. FULL-PANEL PEXELS BACKGROUND IMAGE (Different for Login vs Signup) -->
                  <img src="${leftBgImage}" alt="Kaaba Mecca Background" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; object-position: center; z-index: 1; filter: brightness(0.92) contrast(1.08);">

                  <!-- 2. CRYSTAL-CLEAR SHADOW OVERLAY (No Green Fading) -->
                  <div style="position: absolute; inset: 0; background: linear-gradient(180deg, rgba(0, 0, 0, 0.52) 0%, rgba(0, 0, 0, 0.32) 40%, rgba(0, 0, 0, 0.68) 100%); z-index: 2;"></div>
                  ...
                  <div class="left-panel-content" style="position: relative; z-index: 3; padding: 40px 44px 36px 44px; display: flex; flex-direction: column; justify-content: space-between; height: 100%; box-sizing: border-box;">
                    ...
                    <div class="brand-logo" onclick="app.closeModal(); app.navigate('home');" style="cursor:pointer; display:flex; align-items:center; gap:14px;">
                      <img src="zilhaj-logo.jpg" alt="ZILHAJ Logo" class="brand-logo-img" style="width:48px; height:48px; max-width:48px; max-height:48px; object-fit:contain; border-radius:50%; border: 2px solid #F59E0B; flex-shrink:0; box-shadow: 0 4px 14px rgba(0,0,0,0.5);">
                      <span class="brand-text" style="font-family:'Cinzel', serif; font-size:30px; font-weight:800; letter-spacing:3.5px; color:#FFFFFF; text-shadow:0 3px 12px rgba(0,0,0,0.8);">ZILHAJ</span>
                    </div>

                    <!-- 2. TAGLINE & UNDERLINE (Increased Text Size 36px) -->
                    <div class="tagline-container" style="display:flex; flex-direction:column; gap:4px; margin-top:6px;">
                      <div class="tagline-text-white" style="font-size:36px; font-weight:800; color:#FFFFFF; line-height:1.15; letter-spacing:-0.5px; text-shadow:0 3px 12px rgba(0,0,0,0.8);">One Request.</div>
                      <div class="tagline-text-gold" style="font-size:36px; font-weight:800; color:#F59E0B; line-height:1.15; letter-spacing:-0.5px; text-shadow:0 3px 12px rgba(0,0,0,0.8);">Multiple Verified Offers.</div>
                      <div class="tagline-underline" style="display:flex; align-items:center; gap:0; margin-top:8px;">
                    ...
                    <!-- 3. DESCRIPTION -->
                    <p class="description-text" style="font-size:14.5px; line-height:1.6; color:#F8FAFC; font-weight:500; margin:0; text-shadow:0 2px 8px rgba(0,0,0,0.8);">
                    ...
                    <div class="feature-list" style="display:flex; flex-direction:column; margin-top:8px;">
                      ...
                      <div class="feature-item" style="display:flex; align-items:flex-start; gap:14px; padding:12px 0; border-top:1px solid rgba(255, 255, 255, 0.2);">
                        <div class="feature-badge" style="width:44px; height:44px; border-radius:50%; background:rgba(0, 0, 0, 0.35); backdrop-filter:blur(10px); border:1.5px solid #F59E0B; display:flex; align-items:center; justify-content:center; flex-shrink:0; box-shadow:0 4px 14px rgba(0,0,0,0.5);">
                        ...
                        <div class="feature-info" style="display:flex; flex-direction:column; gap:2px;">
                          <span class="feature-title" style="font-size:15.5px; font-weight:700; color:#FFFFFF; text-shadow:0 2px 6px rgba(0,0,0,0.8);">Verified & Trusted</span>
                          <span class="feature-subtext" style="font-size:13px; color:rgba(255, 255, 255, 0.9); line-height:1.35; text-shadow:0 1px 4px rgba(0,0,0,0.7);">All offers are verified for your peace of mind.</span>
                        </div>
                      </div>
                      ...
                      <div class="feature-item" style="display:flex; align-items:flex-start; gap:14px; padding:12px 0; border-top:1px solid rgba(255, 255, 255, 0.2);">
                        ...
                        <div class="feature-info" style="display:flex; flex-direction:column; gap:2px;">
                          <span class="feature-title" style="font-size:15.5px; font-weight:700; color:#FFFFFF; text-shadow:0 2px 6px rgba(0,0,0,0.8);">Multiple Offers</span>
                          <span class="feature-subtext" style="font-size:13px; color:rgba(255, 255, 255, 0.9); line-height:1.35; text-shadow:0 1px 4px rgba(0,0,0,0.7);">Compare multiple offers and choose what's best for you.</span>
                        </div>
                      </div>

                      <!-- Row 3: Secure & Private -->
                      <div class="feature-item" style="display:flex; align-items:flex-start; gap:14px; padding:12px 0; border-top:1px solid rgba(255, 255, 255, 0.2); border-bottom:1px solid rgba(255, 255, 255, 0.2);">
                        <div class="feature-badge" style="width:44px; height:44px; border-radius:50%; background:rgba(0, 0, 0, 0.35); backdrop-filter:blur(10px); border:1.5px solid #F59E0B; display:flex; align-items:center; justify-content:center; flex-shrink:0; box-shadow:0 4px 14px rgba(0,0,0,0.5);">
                          <svg viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:20px; height:20px;">
                        ...
                        <div class="feature-info" style="display:flex; flex-direction:column; gap:2px;">
                          <span class="feature-title" style="font-size:15.5px; font-weight:700; color:#FFFFFF; text-shadow:0 2px 6px rgba(0,0,0,0.8);">Secure & Private</span>
                          <span class="feature-subtext" style="font-size:13px; color:rgba(255, 255, 255, 0.9); line-height:1.35; text-shadow:0 1px 4px rgba(0,0,0,0.7);">Your data and identity are 100% safe and protected.</span>
                        </div>
                      </div>
                ...
                <main class="right-panel">
                  ...
                  <div class="login-card-container">
                    <div class="login-card ${isRegister ? 'compact-card' : ''}">
                      ...
                      <!-- OR Divider -->
                      <div class="divider-container" style="display:flex; align-items:center; margin:8px 0 6px 0;">
                        <div class="divider-line" style="flex:1; height:1px; background-color:#E2E8F0;"></div>
                        <span class="divider-text" style="padding:0 10px; font-size:11px; font-weight:700; color:#94A3B8;">OR</span>
                        <div class="divider-line" style="flex:1; height:1px; background-color:#E2E8F0;"></div>
                      </div>

                      <!-- Social Buttons Grid -->
                      <div class="social-buttons-grid" style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-bottom:0;">
                        
                        <!-- Google Button -->
                        <button type="button" class="social-btn" onclick="app.loginWithGoogle()" style="height:34px; background:#FFFFFF; border:1px solid #E2E8F0; border-radius:6px; display:flex; align-items:center; justify-content:center; gap:8px; font-size:12px; font-weight:600; color:#1E293B; cursor:pointer;">
                        ...
                        <!-- Apple Button -->
                        <button type="button" class="social-btn" onclick="app.showToast('Apple Sign-In feature available soon', 'info')" style="height:34px; background:#FFFFFF; border:1px solid #E2E8F0; border-radius:6px; display:flex; align-items:center; justify-content:center; gap:8px; font-size:12px; font-weight:600; color:#1E293B; cursor:pointer;">
                          <svg viewBox="0 0 24 24" fill="currentColor" style="width:16px; height:16px;" xmlns="http://www.w3.org/2000/svg">
